...
export function ExperienceCardOne() {
  return (
    <article className="flex flex-col rounded-[50px] items-center flex-shrink-0
    w-[400px] sm:w-[500px] md:w-[700px] xl:w-[900px] snap-center p-10 bg-[#34343d] opacity-40 hover:opacity-100
    cursor-pointer transition-opacity duration-200 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#00bfff]/80">
      <motion.img 
        initial={{
          y: -100,
          opacity: 0
...
export function ExperienceCardTwo() {
  return (
    ...
    cursor-pointer transition-opacity duration-200 overflow-x-hidden overflow-y-auto scrollbar-thin scrollbar-track-gray-400/20 scrollbar-thumb-[#00bfff]/80">
      ...
      <div className="px-0 md:px-0 mt-10">
        <h4 className="text-3xl tracking-wider">Researcher</h4>
